...
/*
 * select id, arrival_date, days_in_transit, is_available, is_free, is_free_for_members, offer_id, shipping_carrier, shipping_charge, "
			+ "shipping_mode
 */
	public ROShipping(Long id, Date availableDate, int daysInTransit, boolean isAvailable, boolean isFree, boolean isFreeShippingForMembers,
			Long offerId,String shipCarrier,  Double shippingCharge, String shippingMode) {
		super();
		this.id = id;
		this.offerId = offerId;
		this.isAvailable = isAvailable;
